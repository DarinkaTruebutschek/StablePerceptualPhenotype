...
run_plot_SD(data=data_demeaned[data_demeaned.Study != 'funcStates'], sess2plot='all', model='DoG', collapseSubs='pooled', 
            stats_n_permutations=1000, my_sig='rsquared', savename=saveNames, bin_width=bin_width, path_results=path_results)
...
run_plot_SD_VariabilityInterSub(currentStudies=currentStudy, model='DoG', collapseSubs='singleSub', stats_n_permutations=1000,
                           my_sig='rsquared', savename=saveNames, bin_width=bin_width+5, path_results=path_results)
